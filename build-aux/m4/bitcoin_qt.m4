...
AC_DEFUN([BITCOIN_QT_CONFIGURE],[
  ...
  if test "$bitcoin_cv_static_qt" = "yes"; then
    ...
    if test "$TARGET_OS" = "windows"; then
      ...
      _BITCOIN_QT_CHECK_STATIC_PLUGIN([QWindowsIntegrationPlugin], [-lQt5PlatformSupport -lqwindows])
      _BITCOIN_QT_CHECK_STATIC_PLUGIN([QWindowsVistaStylePlugin], [-lQt5PlatformSupport -lqwindowsvistastyle])

...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef WALTERCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define WALTERCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the waltercoin network\n')
    ...
    g.write('#endif // WALTERCOIN_CHAINPARAMSSEEDS_H\n')

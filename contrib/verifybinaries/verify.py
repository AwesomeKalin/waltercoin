...
"""Script for verifying Waltercoin Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
waltercoincore.org and waltercoin.org and compares them.
...
WORKINGDIR = "/tmp/waltercoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://waltercoincore.org"
HOST2 = "https://waltercoin.org"
VERSIONPREFIX = "waltercoin-core-"
...
def main(args):
    ...
    if not success:
        print("waltercoin.org failed to provide signature file, "
              "but waltercoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("waltercoin.org and waltercoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Waltercoin Core binary release "

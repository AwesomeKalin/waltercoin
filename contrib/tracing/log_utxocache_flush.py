...
"""Example logging Waltercoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/waltercoind
...
def main(waltercoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[waltercoind_with_usdts])

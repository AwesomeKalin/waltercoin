...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the waltercoin repository."
  exit 1
fi
...
# See https://github.com/waltercoin/waltercoin/issues/16064
...
echo 'When compiling waltercoind, run `./configure` in the following way:'
echo

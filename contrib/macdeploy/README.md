...
When complete, it will have produced `Waltercoin-Core.dmg`.
...
apt install cpio
git clone https://github.com/waltercoin-core/apple-sdk-tools.git
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/waltercoin-core/waltercoin-detached-sigs).

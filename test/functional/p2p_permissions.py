...
class P2PPermissionsTests(WaltercoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].waltercoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].waltercoinconf, 'w', encoding="utf8") as f:
            f.write(newText)

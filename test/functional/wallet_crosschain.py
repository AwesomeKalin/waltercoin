...
class WalletCrossChain(WaltercoinTestFramework):
    ...
    def setup_network(self):
        ...
        with open(self.nodes[1].waltercoinconf, 'r', encoding='utf8') as conf:
            conf_data = conf.read()
        with open (self.nodes[1].waltercoinconf, 'w', encoding='utf8') as conf:

...
Verify that a waltercoind node can use an external signer command.
...
class RPCSignerTest(WaltercoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart waltercoind with -signer=<cmd>',

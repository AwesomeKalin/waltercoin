...
class TestShell:
    """Wrapper Class for WaltercoinTestFramework.

    The TestShell class extends the WaltercoinTestFramework
    ...
    class __TestShell(WaltercoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by WaltercoinTestFramework child class.
            self.num_nodes = 1

...
"""
Test starting waltercoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(WaltercoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that waltercoind has bound on "::1" (for RPC) and "::" (for P2P).

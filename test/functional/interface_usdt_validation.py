...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/waltercoin/waltercoin/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(WaltercoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/waltercoin/waltercoin/blob/master/doc/tracing.md#tracepoint-validationblock_connected

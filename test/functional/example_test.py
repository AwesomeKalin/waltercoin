...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the WaltercoinTestFramework
    pass


class ExampleTest(WaltercoinTestFramework):
    # Each functional test is a subclass of the WaltercoinTestFramework class.
    ...
    def custom_method(self):
        ...
        WaltercoinTestFramework class so other tests can use it."""

...
By default, waltercoind will dump mempool on shutdown and
...
class MempoolPersistTest(WaltercoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent waltercoind from writing mempool.dat to disk. Verify that `savemempool` fails")

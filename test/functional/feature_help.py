...
"""Verify that starting waltercoin with -h works as expected."""

from test_framework.test_framework import WaltercoinTestFramework
from test_framework.util import assert_equal

class HelpTest(WaltercoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start waltercoin with -h for help text")
        ...
        self.log.info("Start waltercoin with -version for version information")
        ...
        self.log.info("Start waltercoind with -fakearg to make sure it does not start")

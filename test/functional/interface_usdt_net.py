...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/waltercoin/waltercoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(WaltercoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our waltercoind node")

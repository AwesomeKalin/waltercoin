...
class TestWaltercoinCli(WaltercoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `waltercoin-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and waltercoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and waltercoin-cli getwalletinfo return expected wallet info")
            ...
            # Test waltercoin-cli -generate with -rpcwallet in multiwallet mode.

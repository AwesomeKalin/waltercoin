...
libs = [
    ...
    'libwaltercoin_crypto',
    'libwaltercoin_node',
    'libwaltercoin_util',
    'libwaltercoin_wallet_tool',
    'libwaltercoin_wallet',
    'libwaltercoin_zmq',
    'bench_waltercoin',
    'libtest_util',
]
...
def parse_config_into_btc_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"Waltercoin Core {version}\""

    with open(os.path.join(SOURCE_DIR,'../build_msvc/waltercoin_config.h.in'), "r", encoding="utf8") as template_file:
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/waltercoin_config.h'), "w", encoding="utf8") as btc_config:
...
def main():
    parser = argparse.ArgumentParser(description='Waltercoin-core msbuild configuration initialiser.')
    ...
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/waltercoin_config.h'), os.path.join(SOURCE_DIR, 'config/waltercoin-config.h'))

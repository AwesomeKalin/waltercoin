    ...
    mapper(nullptr)
{
    ...
    ui->waltercoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->waltercoinAtStartup);
    ...
    ui->waltercoinAtStartup->setToolTip(ui->waltercoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->waltercoinAtStartup->setText(ui->waltercoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openWaltercoinConfButton->setToolTip(ui->openWaltercoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new WaltercoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->waltercoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openWaltercoinConfButton_clicked()
{

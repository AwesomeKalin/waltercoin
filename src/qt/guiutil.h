...
#ifndef WALTERCOIN_QT_GUIUTIL_H
#define WALTERCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Waltercoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "waltercoin:" URI into recipient object, return true on successful parsing

...
//! Entry point for WaltercoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &WaltercoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for WaltercoinGUI tests.
void AppTests::guiTests(WaltercoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &WaltercoinGUI::consoleShown, this, &AppTests::consoleTests);

// Copyright (c) 2018 The Waltercoin Core developers
...
{
    // Test regression https://github.com/waltercoin/waltercoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/waltercoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/waltercoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Waltercoin/Waltercoin-Qt.conf and all else left as default,
    // waltercoin-qt should set both -listen and -listenonion to false and start successfully.

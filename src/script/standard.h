...
#ifndef WALTERCOIN_SCRIPT_STANDARD_H
#define WALTERCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a waltercoin address
 */
...
/**
 * Generate a Waltercoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // WALTERCOIN_SCRIPT_STANDARD_H

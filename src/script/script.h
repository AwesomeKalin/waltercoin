...
#ifndef WALTERCOIN_SCRIPT_SCRIPT_H
#define WALTERCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Waltercoin always counted CHECKMULTISIGs
...
#endif // WALTERCOIN_SCRIPT_SCRIPT_H

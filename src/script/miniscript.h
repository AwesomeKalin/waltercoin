...
#ifndef WALTERCOIN_SCRIPT_MINISCRIPT_H
#define WALTERCOIN_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a waltercoin script
...
#endif // WALTERCOIN_SCRIPT_MINISCRIPT_H

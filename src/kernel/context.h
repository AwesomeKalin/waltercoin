...
#ifndef WALTERCOIN_KERNEL_CONTEXT_H
#define WALTERCOIN_KERNEL_CONTEXT_H
...
//! passed to external libwaltercoin_kernel functions which need access to this
...
#endif // WALTERCOIN_KERNEL_CONTEXT_H

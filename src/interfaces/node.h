...
#ifndef WALTERCOIN_INTERFACES_NODE_H
#define WALTERCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a waltercoin node (waltercoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or waltercoin.conf.
...
#endif // WALTERCOIN_INTERFACES_NODE_H

...
#ifndef WALTERCOIN_INTERFACES_INIT_H
#define WALTERCOIN_INTERFACES_INIT_H
...
//! (waltercoin-gui, waltercoin-node, waltercoin-wallet, waltercoind, waltercoin-qt) and each
...
#endif // WALTERCOIN_INTERFACES_INIT_H

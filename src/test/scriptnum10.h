...
#ifndef WALTERCOIN_TEST_SCRIPTNUM10_H
#define WALTERCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Waltercoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // WALTERCOIN_TEST_SCRIPTNUM10_H

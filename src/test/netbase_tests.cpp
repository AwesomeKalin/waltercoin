...
{
    BOOST_CHECK(TestSplitHost("www.waltercoincore.org", "www.waltercoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.waltercoincore.org]", "www.waltercoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.waltercoincore.org:80", "www.waltercoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.waltercoincore.org]:80", "www.waltercoincore.org", 80));

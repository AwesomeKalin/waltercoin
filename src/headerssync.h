...
#ifndef WALTERCOIN_HEADERSSYNC_H
#define WALTERCOIN_HEADERSSYNC_H
 ...
 *
 * The Waltercoin protocol does not offer an easy way to determine the work on a
...
#endif // WALTERCOIN_HEADERSSYNC_H

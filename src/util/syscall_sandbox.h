...
#ifndef WALTERCOIN_UTIL_SYSCALL_SANDBOX_H
#define WALTERCOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during waltercoind initialization if Waltercoin Core was compiled
...
#endif // WALTERCOIN_UTIL_SYSCALL_SANDBOX_H

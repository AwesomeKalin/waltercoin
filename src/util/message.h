...
#ifndef WALTERCOIN_UTIL_MESSAGE_H
#define WALTERCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's waltercoin address, it must refer to a public key.
...
#endif // WALTERCOIN_UTIL_MESSAGE_H

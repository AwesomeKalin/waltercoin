...
#ifndef WALTERCOIN_IPC_PROCESS_H
#define WALTERCOIN_IPC_PROCESS_H
...
//! IPC process interface for spawning waltercoin processes and serving requests
...
#endif // WALTERCOIN_IPC_PROCESS_H

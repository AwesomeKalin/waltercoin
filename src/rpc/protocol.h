...
#ifndef WALTERCOIN_RPC_PROTOCOL_H
#define WALTERCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in waltercoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Waltercoin is not connected
...
#endif // WALTERCOIN_RPC_PROTOCOL_H

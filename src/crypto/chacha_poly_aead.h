// Copyright (c) 2019-2021 The Waltercoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef WALTERCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define WALTERCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@waltercoin.
 *
 ...
 *
 * The chacha20-poly1305@waltercoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@waltercoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@waltercoin are relatively fast in
...
#endif // WALTERCOIN_CRYPTO_CHACHA_POLY_AEAD_H

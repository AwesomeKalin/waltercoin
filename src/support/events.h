// Copyright (c) 2016-2018 The Waltercoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef WALTERCOIN_SUPPORT_EVENTS_H
#define WALTERCOIN_SUPPORT_EVENTS_H
...
#endif // WALTERCOIN_SUPPORT_EVENTS_H

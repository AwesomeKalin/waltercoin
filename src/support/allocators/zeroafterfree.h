...
#ifndef WALTERCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define WALTERCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // WALTERCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H

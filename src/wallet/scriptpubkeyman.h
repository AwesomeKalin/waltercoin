...
#ifndef WALTERCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define WALTERCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Waltercoin Core wallet was originally a collection of unrelated private
...
#endif // WALTERCOIN_WALLET_SCRIPTPUBKEYMAN_H

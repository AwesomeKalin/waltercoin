...
#ifndef WALTERCOIN_WALLET_WALLETUTIL_H
#define WALTERCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! waltercoin from opening the wallet, thinking it was newly created, and
...
#endif // WALTERCOIN_WALLET_WALLETUTIL_H

...
#ifndef WALTERCOIN_WALLET_ISMINE_H
#define WALTERCOIN_WALLET_ISMINE_H
 ...
 * https://github.com/waltercoin/waltercoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // WALTERCOIN_WALLET_ISMINE_H

...
#ifndef WALTERCOIN_WALLET_TRANSACTION_H
#define WALTERCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this waltercoin node, and set to 0 for transactions that were created
...
#endif // WALTERCOIN_WALLET_TRANSACTION_H

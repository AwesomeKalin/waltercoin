...
#ifndef WALTERCOIN_NODE_CONNECTION_TYPES_H
#define WALTERCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/waltercoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Waltercoin’s Peer-to-Peer Network")
...
#endif // WALTERCOIN_NODE_CONNECTION_TYPES_H

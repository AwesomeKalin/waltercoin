When Waltercoin Core automatically opens outgoing P2P connections, it chooses
...
A malicious actor may gossip an address:port where no Waltercoin node is listening,
or one where a service is listening that is not related to the Waltercoin network.
As a result, this service may occasionally get connection attempts from Waltercoin
nodes.

"Bad" ports are ones used by services which are usually not open to the public
and usually require authentication. A connection attempt (by Waltercoin Core,
trying to connect because it thinks there is a Waltercoin node on that
...
Below is a list of "bad" ports which Waltercoin Core avoids when choosing a peer to
...
[pull/23306](https://github.com/waltercoin/waltercoin/pull/23306#issuecomment-947516736)

[pull/23542](https://github.com/waltercoin/waltercoin/pull/23542)

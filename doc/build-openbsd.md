...
This guide describes how to build waltercoind, command-line utilities, and GUI on OpenBSD.
...
Waltercoin Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, Qt 5 is required.
...
(see issue [#6658](https://github.com/waltercoin/waltercoin/issues/6658)).

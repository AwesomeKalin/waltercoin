...
Assumeutxo is a feature that allows fast bootstrapping of a validating waltercoind
...
- [Github issue](https://github.com/waltercoin/waltercoin/issues/15605)
- [draft PR](https://github.com/waltercoin/waltercoin/pull/15606)
...
considered active. This is the "traditional" mode of operation for waltercoind.
...
**Failure consideration:** if waltercoind unexpectedly halts after `m_stop_use` is set on
...
### Waltercoind restarts sometime after snapshot validation has completed

When waltercoind initializes again, what began as the snapshot chainstate is now

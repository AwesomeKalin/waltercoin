...
This document provides guidelines for internationalization of the Waltercoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `waltercoin_en.ts` remains unchanged.

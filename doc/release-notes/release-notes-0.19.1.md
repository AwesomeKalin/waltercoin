...
Waltercoin Core version 0.19.1 is now available from:

  <https://waltercoincore.org/bin/waltercoin-core-0.19.1/>
...
From Waltercoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Waltercoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Waltercoin Core does not yet change appearance when
...
- #17488 fix "waltercoind already running" warnings on macOS (fanquake)

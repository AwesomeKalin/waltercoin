Waltercoin Core version 0.9.4 is now available from:

  https://waltercoin.org/bin/0.9.4/
...
this update is incompatible with the Waltercoin system and could lead to consensus
forks.

Waltercoin Core released binaries from https://waltercoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~waltercoin/+archive/ubuntu/waltercoin
- A third-party or self-compiled Waltercoin Core

upgrade to Waltercoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

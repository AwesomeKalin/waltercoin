Waltercoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/waltercoin/files/Waltercoin/waltercoin-0.5.4/
...
http://gitorious.org/waltercoin/waltercoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Waltercoin-Qt notifications under Growl 1.3.
Increase required age of Waltercoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxWaltercoin properly when installing Waltercoin-Qt over it. (Windows)

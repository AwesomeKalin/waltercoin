Waltercoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/waltercoin/files/Waltercoin/waltercoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Waltercoin
...
New/changed settings (command-line or waltercoin.conf file)
--------------------------------------------------------

Waltercoin Core version *0.15.0.1* is now available from:

  <https://waltercoin.org/bin/waltercoin-core-0.15.0.1/>

and

  <https://waltercoincore.org/bin/waltercoin-core-0.15.0.1/>

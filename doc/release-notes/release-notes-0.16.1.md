Waltercoin Core version 0.16.1 is now available from:

  <https://waltercoincore.org/bin/waltercoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting waltercoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure waltercoind processes are cleaned up when tests end (sdaftuar)

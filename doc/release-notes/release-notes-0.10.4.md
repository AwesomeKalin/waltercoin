Waltercoin Core version 0.10.4 is now available from:

  <https://waltercoin.org/bin/waltercoin-core-0.10.4/>
...
- #6953 `43c2789` Split waltercoin-tx into its own package
- #6953 `dfe0d4d` Include waltercoin-tx binary on Debian/Ubuntu

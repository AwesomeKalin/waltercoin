Waltercoin Core version *0.15.2* is now available from:

  <https://waltercoincore.org/bin/waltercoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in waltercoin-tx (TheBlueMatt)

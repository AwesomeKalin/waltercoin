Waltercoin Core version 0.13.2 is now available from:

  <https://waltercoin.org/bin/waltercoin-core-0.13.2/>
...
- #8908 `4a974b2` Update waltercoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow waltercoin-tx to create v2 transactions (btcdrak)
